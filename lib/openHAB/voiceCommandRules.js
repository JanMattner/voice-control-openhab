...
rbi.addRule(seq(
    ...
    opt(onOff),
    allThe,
    item({ type: "Switch", tag: "Light", matchMultiple: true }, { expr: seq(lights, opt(onOff), inOfThe, item({ type: "Group" })), groupContext: "last" }),
    opt(onOff))
);
rbi.addRule(seq(
    turn,
    opt(onOff),
    allThe,
    item({ type: "Switch", tag: "Light", matchMultiple: true }, { expr: seq(item({ type: "Group" }), lights), groupContext: "last" }),
    opt(onOff))
);
...
rbi.addRule(
    seq(
        ...
        opt(upDown),
        allThe,
    item({ type: "Rollershutter", matchMultiple: true }, { expr: seq(rollershutters, opt(upDown), inOfThe, item({ type: "Group" })), groupContext: "last" }),
        opt(upDown),
    )
);
rbi.addRule(
    seq(
        lowerRaise,
        allThe,
    item({ type: "Rollershutter", matchMultiple: true }, { expr: seq(rollershutters, inOfThe, item({ type: "Group" })), groupContext: "last" })
    )
);
rbi.addRule(
    seq(
        ...
        opt(upDown),
        allThe,
    item({ type: "Rollershutter", matchMultiple: true }, { expr: seq(item({ type: "Group" }), rollershutters), groupContext: "last" }),
        opt(upDown),
    )
);
rbi.addRule(
...
rbi.addRule(seq(
    schalte,
    alleDie,
    item({ type: "Switch", tag: "Light", matchMultiple: true }, { expr: seq(lichter, opt(einAnAus), imIn, item({ type: "Group" })), groupContext: "last" }),
    opt(einAnAus))
);
...
rbi.addRule(
    seq(
        fahre,
        denDieDas,
    item({ type: "Rollershutter", matchMultiple: true }, { expr: seq(rollos, imIn, item({ type: "Group" })), groupContext: "last" }),
        hochRunter
    )
);
